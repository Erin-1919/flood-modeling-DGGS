...
centroid_gdf = gbfc.nearest_interp_df('Data/out_nlflow_1_wgs84.tif','nhn1',centroid_gdf,'lon_c','lat_c')
centroid_gdf = gbfc.nearest_interp_df('Data/out_waterbody_2_wgs84.tif','nhn2',centroid_gdf,'lon_c','lat_c')
