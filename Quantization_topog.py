...
sdf = gbfc.bilinear_interp_df(sdf,'Data/NB_DTM_O_30_wgs84.tif','model_elev','lon_c','lat_c')
...
sdf = dtfc.curvature_df(sdf,elev_df,dggs_res,cell_spacing)
sdf = dtfc.roughness_df(sdf,elev_df,dggs_res,vertical_res,1)
